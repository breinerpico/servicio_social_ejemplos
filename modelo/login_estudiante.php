...
<body>
  <div class="login-box">
    ...
    <form action="loguearse_estudiante.php" method="POST">
      <label for="estudiante_correo">Correo electrónico</label>
      <input type="email" name="correo" id="admin_correo" required>

      <label for="estudiante_password">Contraseña</label>
      <input type="password" name="password" id="estudiante_password" required>
